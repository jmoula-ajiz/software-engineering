...
public class HandlerFactory2 extends HandlerFactoryBase<ExpressionV2> implements IHandlerFactory2<ExpressionV2> {
    private static final Dict2<String> CN = new Dict2<>(new ClassNamesDict(), "LambdaExpression");
    private static final Dict2<BindingPower> BP = new Dict2<>(new BindingPowersDict(), new BindingPower(30, true));
    ...
    public Function<ExpressionV2, BindingPower> createBindingPowerHandler() { return dictReader(BP); }
    ...
    public Function<ExpressionV2, IExpressionDict<Integer>> histogram() { return (Function) h(); }

    @SuppressWarnings("unchecked")
    public Function<ExpressionV2, IExpressionDict2<Integer>> histogram2() { return (Function) h(); }

    public IExpressionDict2<String> collectClassNamesDict() { return CN; }
}

final class W {
    static class A<R, E> extends FallbackVisitor<R, E> implements ExpressionVisitorV2<R, E> {
    ...
    static class E extends ExpressionMapper<ExpressionV2> implements ExpressionVisitorV2<ExpressionV2, ExpressionV2> {
        private final Factory2 f2;
        E(IHandlerFactory<ExpressionV2> h, BiFunction<ExpressionV2, Supplier<ExpressionV2>, ExpressionV2> r, BiFunction<ExpressionV2, ExpressionMapper<ExpressionV2>, ExpressionV2> a) {
            super(h, r, a);
            f2 = (Factory2) h.expressionFactory();
        }
        public ExpressionV2 visitLambda(LambdaExpression<ExpressionV2> e) { return f2.lambdaExpression(e.parameter, apply(e.body)); }
    }

    static class C<E> extends ExpressionChildren<E> implements ExpressionVisitorV2<List<E>, E> {
        public List<E> visitLambda(LambdaExpression<E> e) { return List.of(e.body); }
    }

    static class K extends ConstantFolderOnce<ExpressionV2> implements ExpressionVisitorV2<ExpressionV2, ExpressionV2> {
        private final ExpressionV2 r;
        K(Factory2 f, ExpressionV2 root, Function<ExpressionV2, Either<Literal<ExpressionV2>, ExpressionV2>> il) {
            super(f, root, il);
            r = root;
        }
    ...
    static class G<T, E> extends IsomorphicGetter<T, E> implements ExpressionVisitorV2<T, E> {
    ...
    static class S<T, E> extends IsomorphicSetter<T, E> implements ExpressionVisitorV2<Void, E> {
    ...
    static class P implements ExpressionVisitorV2<ExpressionV2, ExpressionV2> {
        private final Factory2 f;
        private final UnaryOperator<ExpressionV2> o;
        P(Factory2 f, UnaryOperator<ExpressionV2> o) { this.f = f; this.o = o; }
        private ExpressionV2 n(ExpressionV2 x) { return o.apply(x); }
        ...
        public ExpressionV2 visit(Addition<ExpressionV2> e) { return f.addition(n(e.left), n(e.right)); }
        public ExpressionV2 visit(Subtraction<ExpressionV2> e) { return f.subtraction(n(e.left), n(e.right)); }
        public ExpressionV2 visit(Multiplication<ExpressionV2> e) { return f.multiplication(n(e.left), n(e.right)); }
        public ExpressionV2 visit(Division<ExpressionV2> e) { return f.division(n(e.dividend), n(e.divisor)); }
        public ExpressionV2 visit(Negation<ExpressionV2> e) { return f.negation(n(e.operand)); }
        public ExpressionV2 visit(Modulo<ExpressionV2> e) { return f.modulo(n(e.left), n(e.right)); }
        public ExpressionV2 visit(Exponentiation<ExpressionV2> e) { return f.exponentiation(n(e.base), n(e.exponent)); }
        public ExpressionV2 visit(Equality<ExpressionV2> e) { return f.equality(n(e.left), n(e.right)); }
        public ExpressionV2 visit(Inequality<ExpressionV2> e) { return f.inequality(n(e.left), n(e.right)); }
        public ExpressionV2 visit(LessThan<ExpressionV2> e) { return f.lessThan(n(e.left), n(e.right)); }
        public ExpressionV2 visit(GreaterThan<ExpressionV2> e) { return f.greaterThan(n(e.left), n(e.right)); }
        public ExpressionV2 visit(LessThanOrEqual<ExpressionV2> e) { return f.lessThanOrEqual(n(e.left), n(e.right)); }
        public ExpressionV2 visit(GreaterThanOrEqual<ExpressionV2> e) { return f.greaterThanOrEqual(n(e.left), n(e.right)); }
        public ExpressionV2 visit(Conjunction<ExpressionV2> e) { return f.conjunction(n(e.left), n(e.right)); }
        public ExpressionV2 visit(Disjunction<ExpressionV2> e) { return f.disjunction(n(e.left), n(e.right)); }
        public ExpressionV2 visit(LogicalNot<ExpressionV2> e) { return f.logicalNot(n(e.operand)); }
        public ExpressionV2 visit(Conditional<ExpressionV2> e) { return f.conditional(n(e.condition), n(e.whenTrue), n(e.whenFalse)); }
        public ExpressionV2 visit(FunctionCall<ExpressionV2> e) { return f.functionCall(n(e.callee), e.arguments.stream().map(o).toList()); }
        public ExpressionV2 visitLambda(LambdaExpression<ExpressionV2> e) { return f.lambdaExpression(e.parameter, n(e.body)); }
    }

    static class J extends ExpressionToJsLikeSyntax<ExpressionV2> implements ExpressionVisitorV2<String, ExpressionV2> {
    ...
    static class L extends ExpressionToLispLikeSyntax<ExpressionV2> implements ExpressionVisitorV2<String, ExpressionV2> {
        private final IHandlerFactory<ExpressionV2> h;
